...
namespace App\Facades { 
    ...
    class Influx {
        ...
        {
            return \InfluxDB\Client::selectDB($name);
        }
         ...
         * @static 
         */ 
        public static function query($database, $query, $parameters = array())
        {
            return \InfluxDB\Client::query($database, $query, $parameters);
        }
         ...
         * @static 
         */ 
        public static function write($parameters, $payload)
        {
            return \InfluxDB\Client::write($parameters, $payload);
        }
        ...
        {
            return \InfluxDB\Client::listDatabases();
        }
        ...
        {
            return \InfluxDB\Client::listUsers();
        }
        ...
        {
            return \InfluxDB\Client::getBaseURI();
        }
        ...
        {
            return \InfluxDB\Client::getTimeout();
        }
        
        /**
         * 
         *
         * @param \InfluxDB\Driver\DriverInterface $driver
         * @static 
         */ 
        public static function setDriver($driver)
        {
            return \InfluxDB\Client::setDriver($driver);
        }
        
        /**
         * 
         *
         * @return \InfluxDB\DriverInterface|\InfluxDB\QueryDriverInterface 
         * @static 
         */ 
        public static function getDriver()
        {
            return \InfluxDB\Client::getDriver();
        }
        ...
        public static function getHost()
        {
            return \InfluxDB\Client::getHost();
        }
        ...
        {
            return \InfluxDB\Client::getLastQuery();
        }
    ...
    class InfluxDB {
        ...
        public static function getName()
        {
            return \InfluxDB\Database::getName();
        }
        ...
        {
            return \InfluxDB\Database::query($query, $params);
        }
        
        /**
         * Create this database
         *
         * @param \InfluxDB\RetentionPolicy $retentionPolicy
         * @param bool $createIfNotExists Deprecated parameter - to be removed
         * @return \InfluxDB\ResultSet 
         * @throws DatabaseException
         * @static 
         */ 
        public static function create($retentionPolicy = null, $createIfNotExists = false)
        {
            return \InfluxDB\Database::create($retentionPolicy, $createIfNotExists);
        }
         ...
         * @static 
         */ 
        public static function createRetentionPolicy($retentionPolicy)
        {
            return \InfluxDB\Database::createRetentionPolicy($retentionPolicy);
        }
         ...
         * data into InfluxDB.
         *
         * @param \InfluxDB\Point[] $points Array of Point objects
         ...
         * @static 
         */ 
        public static function writePoints($points, $precision = 'n', $retentionPolicy = null)
        {
            return \InfluxDB\Database::writePoints($points, $precision, $retentionPolicy);
        }
         ...
         * @static 
         */ 
        public static function writePayload($payload, $precision = 'n', $retentionPolicy = null)
        {
            return \InfluxDB\Database::writePayload($payload, $precision, $retentionPolicy);
        }
        ...
        {
            return \InfluxDB\Database::exists();
        }
         ...
         * @static 
         */ 
        public static function alterRetentionPolicy($retentionPolicy)
        {
            return \InfluxDB\Database::alterRetentionPolicy($retentionPolicy);
        }
         ...
         * @static 
         */ 
        public static function listRetentionPolicies()
        {
            return \InfluxDB\Database::listRetentionPolicies();
        }
        ...
        {
            return \InfluxDB\Database::drop();
        }
        
        /**
         * Retrieve the query builder
         *
         * @return \InfluxDB\QueryBuilder 
         * @static 
         */ 
        public static function getQueryBuilder()
        {
            return \InfluxDB\Database::getQueryBuilder();
        }
        ...
        {
            return \InfluxDB\Database::getClient();
        }
...
namespace  { 
    ...
    class Influx extends \App\Facades\Influx {}

    class InfluxDB extends \App\Facades\InfluxDB {}
